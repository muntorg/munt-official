...
Run with the -testnet option to run with "play guldens" on the test network, if you
...
- GuldenMiner : Generates guldens (if wallet is enabled).
...
Some of these are maintained by active developers of Gulden Core, in which case changes should probably go
directly upstream without being PRed directly against the project.  They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project.  Changes to these should also
be sent upstream but bugfixes may also be prudent to PR against Gulden Core so that they can be integrated
...
- src/libsecp256k1
  - Upstream at https://github.com/gulden-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/gulden-core/ctaes ; actively maintained by Core contributors.
