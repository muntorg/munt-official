...
Run with the -testnet option to run with "play guldencoins" on the test network, if you
...
Guldencoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- GuldencoinMiner : Generates guldencoins (if wallet is enabled).
