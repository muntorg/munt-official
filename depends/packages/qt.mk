...
$(package)_linux_dependencies=freetype fontconfig libxcb libX11 xproto libXext libXrender renderproto concurrent
...
define $(package)_config_cmds
  ...
  OPENSSL_LIBS='-L$(host_prefix)/lib -lssl -lcrypto $($(package)_ssl_extras)' ./configure $($(package)_config_opts) && \
