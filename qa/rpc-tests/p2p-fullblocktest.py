#!/usr/bin/env python3
# Copyright (c) 2015-2016 The Gulden Core developers
...
'''
This reimplements tests from the guldenj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure GuldenD isn't accepting b26
        ...
        # Extend the b28 chain to make sure GuldenD isn't accepting b28
