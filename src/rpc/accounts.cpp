...
static UniValue calculateholdingweight(const JSONRPCRequest& request)
{
    #ifdef ENABLE_WALLET
    CWallet * const pwallet = GetWalletForJSONRPCRequest(request);
    LOCK2(cs_main, pwallet ? &pwallet->cs_wallet : NULL);
...
{ //  category                   name                               actor (function)                 okSafeMode
  //  ---------------------      ------------------------           -----------------------          ----------
    ...
    { "hidden",                 "createwitnessaccount",            &createwitnessaccount,           true,    {"name"} },
    { "hidden",                 "calculatewitnessweight",          &calculateholdingweight,         true,    { "amount", "time" } },
    { "hidden",                 "extendwitnessaccount",            &extendwitnessaccount,           true,    {"funding_account", "witness_account", "amount", "time" } },
    { "hidden",                 "extendwitnessaddress",            &extendwitnessaddress,           true,    {"funding_account", "witness_address", "amount", "time" } },
    { "hidden",                 "fundwitnessaccount",              &fundwitnessaccount,             true,    {"funding_account", "witness_account", "amount", "time", "force_multiple" } },
    { "hidden",                 "getwitnessaccountkeys",           &getwitnessaccountkeys,          true,    {"witness_account"} },
    { "hidden",                 "getwitnessaddresskeys",           &getwitnessaddresskeys,          true,    {"witness_address"} },
    { "hidden",                 "getwitnesscompound",              &getwitnesscompound,             true,    {"witness_account"} },
    { "hidden",                 "getwitnessinfo",                  &getwitnessinfo,                 true,    {"block_specifier", "verbose", "mine_only"} },
    { "hidden",                 "getwitnessrewardscript",          &getwitnessrewardscript,         true,    {"witness_account"} },
    { "hidden",                 "importwitnesskeys",               &importwitnesskeys,              true,    {"account_name", "encoded_key_url", "create_account"} },
    { "hidden",                 "mergewitnessaccount",             &mergewitnessaccount,            true,    {"funding_account", "witness_account"} },
    { "hidden",                 "rotatewitnessaddress",            &rotatewitnessaddress,           true,    {"funding_account", "witness_address"} },
    { "hidden",                 "rotatewitnessaccount",            &rotatewitnessaccount,           true,    {"funding_account", "witness_account"} },
    { "hidden",                 "renewwitnessaccount",             &renewwitnessaccount,            true,    {"funding_account", "witness_account"} },
    { "hidden",                 "setwitnesscompound",              &setwitnesscompound,             true,    {"witness_account", "amount"} },
    { "hidden",                 "setwitnessrewardscript",          &setwitnessrewardscript,         true,    {"witness_account", "pubkey_or_script", "force_pubkey"} },
    { "hidden",                 "setwitnessrewardtemplate",        &setwitnessrewardtemplate,       true,    {"witness_account", "reward_template"} },
    { "hidden",                 "getwitnessrewardtemplate",        &getwitnessrewardtemplate,       true,    {"witness_account" } },
    { "hidden",                 "splitwitnessaccount",             &splitwitnessaccount,            true,    {"funding_account", "witness_account", "amounts"} },
    ...
    { "holding",                "extendholdingaddress",            &extendwitnessaddress,           true,    {"funding_account", "witness_address", "amount", "time" } },
    { "holding",                "fundholdingaccount",              &fundwitnessaccount,             true,    {"funding_account", "witness_account", "amount", "time", "force_multiple" } },
    { "holding",                "getholdingaccountkeys",           &getwitnessaccountkeys,          true,    {"witness_account"} },
    { "holding",                "getholdingaddresskeys",           &getwitnessaddresskeys,          true,    {"witness_address"} },
    { "holding",                "getholdingcompound",              &getwitnesscompound,             true,    {"witness_account"} },
    { "holding",                "getholdinginfo",                  &getwitnessinfo,                 true,    {"block_specifier", "verbose", "mine_only"} },
    { "holding",                "getholdingrewardscript",          &getwitnessrewardscript,         true,    {"witness_account"} },
    { "holding",                "importholdingkeys",               &importwitnesskeys,              true,    {"account_name", "encoded_key_url", "create_account"} },
    { "holding",                "mergeholdingaccount",             &mergewitnessaccount,            true,    {"funding_account", "witness_account"} },
    { "holding",                "rotateholdingaddress",            &rotatewitnessaddress,           true,    {"funding_account", "witness_address"} },
    { "holding",                "rotateholdingaccount",            &rotatewitnessaccount,           true,    {"funding_account", "witness_account"} },
    { "holding",                "renewholdingaccount",             &renewwitnessaccount,            true,    {"funding_account", "witness_account"} },
    { "holding",                "setholdingcompound",              &setwitnesscompound,             true,    {"witness_account", "amount"} },
    { "holding",                "setholdingrewardscript",          &setwitnessrewardscript,         true,    {"witness_account", "pubkey_or_script", "force_pubkey"} },
    { "holding",                "setholdingrewardtemplate",        &setwitnessrewardtemplate,       true,    {"witness_account", "reward_template"} },
    { "holding",                "getholdingrewardtemplate",        &getwitnessrewardtemplate,       true,    {"witness_account" } },
    { "holding",                "splitholdingaccount",             &splitwitnessaccount,            true,    {"funding_account", "witness_account", "amounts"} },
    { "holding",                "enableholding",                   &enablewitnessing,               true,    {} },
    { "holding",                "disableholding",                  &disablewitnessing,              true,    {} },
    { "holding",                "repairholdingaddress",            &repairwitnessaddress,           true,    {"witness_address" } },
