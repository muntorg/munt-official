...
#define next_addresses next_addresses_sse3
#define fill_segment fill_segment_sse3
#define fill_block fill_block_sse3
#define initialize initialize_sse3
#define fill_memory_blocks fill_memory_blocks_sse3
#define argon2_echo_ctx argon2_echo_ctx_sse3
#define Compress argon2_echo_compress_sse3
#define init_block_value argon2_echo_init_block_value_sse3
#define copy_block argon2_echo_copy_block_value_sse3
#define xor_block argon2_echo_xor_block_value_sse3
#define finalize argon2_echo_finalize_sse3
#define index_alpha argon2_echo_index_alpha_sse3
#define initial_hash argon2_echo_initial_hash_sse3
#define fill_first_blocks argon2_echo_fill_first_blocks_sse3
