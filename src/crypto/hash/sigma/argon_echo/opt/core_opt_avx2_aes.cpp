...
#define next_addresses next_addresses_avx2_aes
#define fill_segment fill_segment_avx2_aes
#define fill_block fill_block_avx2_aes
#define initialize initialize_avx2_aes
#define fill_memory_blocks fill_memory_blocks_avx2_aes
#define argon2_echo_ctx argon2_echo_ctx_avx2_aes
#define Compress argon2_echo_compress_avx2_aes
#define init_block_value argon2_echo_init_block_value_avx2_aes
#define copy_block argon2_echo_copy_block_value_avx2_aes
#define xor_block argon2_echo_xor_block_value_avx2_aes
#define finalize argon2_echo_finalize_avx2_aes
#define index_alpha argon2_echo_index_alpha_avx2_aes
#define initial_hash argon2_echo_initial_hash_avx2_aes
#define fill_first_blocks argon2_echo_fill_first_blocks_avx2_aes
