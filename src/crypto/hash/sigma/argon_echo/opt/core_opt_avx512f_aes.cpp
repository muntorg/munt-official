...
#define next_addresses next_addresses_avx512f_aes
#define fill_segment fill_segment_avx512f_aes
#define fill_block fill_block_avx512f_aes
#define initialize initialize_avx512f_aes
#define fill_memory_blocks fill_memory_blocks_avx512f_aes
#define argon2_echo_ctx argon2_echo_ctx_avx512f_aes
#define Compress argon2_echo_compress_avx512f_aes
#define init_block_value argon2_echo_init_block_value_avx512f_aes
#define copy_block argon2_echo_copy_block_value_avx512f_aes
#define xor_block argon2_echo_xor_block_value_avx512f_aes
#define finalize argon2_echo_finalize_avx512f_aes
#define index_alpha argon2_echo_index_alpha_avx512f_aes
#define initial_hash argon2_echo_initial_hash_avx512f_aes
#define fill_first_blocks argon2_echo_fill_first_blocks_avx512f_aes
...
static void fill_block_avx512f_aes(__m512i* state, const argon2_echo_block* ref_block, argon2_echo_block* next_block, int with_xor)
{
