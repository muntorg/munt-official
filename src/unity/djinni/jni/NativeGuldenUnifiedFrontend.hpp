...
private:
    ...
    public:
        ...
        void notifyNewMutation(const ::MutationRecord & mutation) override;
    ...
    const jmethodID method_notifyNewMutation { ::djinni::jniGetMethodID(clazz.get(), "notifyNewMutation", "(Lcom/gulden/jniunifiedbackend/MutationRecord;)V") };
