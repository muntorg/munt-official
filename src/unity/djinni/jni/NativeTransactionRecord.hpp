...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("com/novocurrency/jniunifiedbackend/TransactionRecord") };
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Ljava/lang/String;JJJLcom/novocurrency/jniunifiedbackend/TransactionStatus;IJILjava/util/ArrayList;Ljava/util/ArrayList;)V") };
    ...
    const jfieldID field_mStatus { ::djinni::jniGetFieldID(clazz.get(), "mStatus", "Lcom/novocurrency/jniunifiedbackend/TransactionStatus;") };
