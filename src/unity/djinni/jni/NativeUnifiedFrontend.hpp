...
class NativeUnifiedFrontend final : ::djinni::JniInterface<::UnifiedFrontend, NativeUnifiedFrontend> {
public:
    using CppType = std::shared_ptr<::UnifiedFrontend>;
    using CppOptType = std::shared_ptr<::UnifiedFrontend>;
    using JniType = jobject;

    using Boxed = NativeUnifiedFrontend;

    ~NativeUnifiedFrontend();

    static CppType toCpp(JNIEnv* jniEnv, JniType j) { return ::djinni::JniClass<NativeUnifiedFrontend>::get()._fromJava(jniEnv, j); }
    static ::djinni::LocalRef<JniType> fromCppOpt(JNIEnv* jniEnv, const CppOptType& c) { return {jniEnv, ::djinni::JniClass<NativeUnifiedFrontend>::get()._toJava(jniEnv, c)}; }
    static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c) { return fromCppOpt(jniEnv, c); }

private:
    NativeUnifiedFrontend();
    friend ::djinni::JniClass<NativeUnifiedFrontend>;
    friend ::djinni::JniInterface<::UnifiedFrontend, NativeUnifiedFrontend>;

    class JavaProxy final : ::djinni::JavaProxyHandle<JavaProxy>, public ::UnifiedFrontend
    {
    public:
        JavaProxy(JniType j);
        ~JavaProxy();
