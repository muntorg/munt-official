...
#include "NativeUnifiedFrontend.hpp"  // my header
#include "Marshal.hpp"
...
NativeUnifiedFrontend::NativeUnifiedFrontend() : ::djinni::JniInterface<::UnifiedFrontend, NativeUnifiedFrontend>() {}

NativeUnifiedFrontend::~NativeUnifiedFrontend() = default;

NativeUnifiedFrontend::JavaProxy::JavaProxy(JniType j) : Handle(::djinni::jniGetThreadEnv(), j) { }

NativeUnifiedFrontend::JavaProxy::~JavaProxy() = default;

void NativeUnifiedFrontend::JavaProxy::notifyUnifiedProgress(float c_progress) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyBalanceChange(const ::BalanceRecord & c_new_balance) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyNewMutation(const ::MutationRecord & c_mutation, bool c_self_committed) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyUpdatedTransaction(const ::TransactionRecord & c_transaction) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyInitWithExistingWallet() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyInitWithoutExistingWallet() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyShutdown() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::notifyCoreReady() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
...
void NativeUnifiedFrontend::JavaProxy::logPrint(const std::string & c_str) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeUnifiedFrontend>::get();
