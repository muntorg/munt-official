...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("com/florin/jniunifiedbackend/MutationRecord") };
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(JJLjava/lang/String;Ljava/lang/String;Lcom/florin/jniunifiedbackend/TransactionStatus;I)V") };
