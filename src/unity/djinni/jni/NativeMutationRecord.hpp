...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(JJLjava/lang/String;Ljava/lang/String;Lcom/gulden/jniunifiedbackend/TransactionStatus;I)V") };
