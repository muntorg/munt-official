...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("com/novocurrency/jniunifiedbackend/MutationRecord") };
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(JJLjava/lang/String;Lcom/novocurrency/jniunifiedbackend/TransactionStatus;I)V") };
