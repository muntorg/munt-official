...
Napi::Value NJSGuldenUnifiedBackend::InitUnityLib(const Napi::CallbackInfo& info) {
    ...
    std::shared_ptr<NJSGuldenUnifiedFrontend> arg_6(std::shared_ptr<NJSGuldenUnifiedFrontend>{}, NJSGuldenUnifiedFrontend::Unwrap(info[6].As<Napi::Object>()));
...
void NJSGuldenUnifiedBackend::RegisterMonitorListener(const Napi::CallbackInfo& info) {
    ...
    //Check if parameters have correct types
    std::shared_ptr<NJSGuldenMonitorListener> arg_0(std::shared_ptr<NJSGuldenMonitorListener>{}, NJSGuldenMonitorListener::Unwrap(info[0].As<Napi::Object>()));
