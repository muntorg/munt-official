...
Napi::Value NJSIWitnessController::getAccountWitnessStatistics(const Napi::CallbackInfo& info) {
    ...
    try
    {
        ...
        auto arg_1_4 = Napi::Value::From(env, result.account_parts);
        arg_1.Set("account_parts", arg_1_4);
        auto arg_1_5 = Napi::Value::From(env, result.account_amount_locked);
        arg_1.Set("account_amount_locked", arg_1_5);
        auto arg_1_6 = Napi::Value::From(env, result.account_weight_at_creation);
        arg_1.Set("account_weight_at_creation", arg_1_6);
        auto arg_1_7 = Napi::Value::From(env, result.network_tip_total_weight);
        arg_1.Set("network_tip_total_weight", arg_1_7);
        auto arg_1_8 = Napi::Value::From(env, result.network_total_weight_at_account_creation_time);
        arg_1.Set("network_total_weight_at_account_creation_time", arg_1_8);
        auto arg_1_9 = Napi::Value::From(env, result.account_initial_lock_period_in_blocks);
        arg_1.Set("account_initial_lock_period_in_blocks", arg_1_9);
        auto arg_1_10 = Napi::Value::From(env, result.account_remaining_lock_period_in_blocks);
        arg_1.Set("account_remaining_lock_period_in_blocks", arg_1_10);
        auto arg_1_11 = Napi::Value::From(env, result.account_expected_witness_period_in_blocks);
        arg_1.Set("account_expected_witness_period_in_blocks", arg_1_11);
        auto arg_1_12 = Napi::Value::From(env, result.account_estimated_witness_period_in_blocks);
        arg_1.Set("account_estimated_witness_period_in_blocks", arg_1_12);
        auto arg_1_13 = Napi::Value::From(env, result.account_initial_lock_creation_block_height);
        arg_1.Set("account_initial_lock_creation_block_height", arg_1_13);
        auto arg_1_14 = Napi::Value::From(env, result.account_is_compounding);
        arg_1.Set("account_is_compounding", arg_1_14);
