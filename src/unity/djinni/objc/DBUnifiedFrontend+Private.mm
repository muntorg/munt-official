...
class UnifiedFrontend::ObjcProxy final
: public ::UnifiedFrontend
, private ::djinni::ObjcProxyBase<ObjcType>
{
    friend class ::djinni_generated::UnifiedFrontend;
public:
...
auto UnifiedFrontend::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto UnifiedFrontend::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
