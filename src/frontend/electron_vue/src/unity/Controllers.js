...
return handleError(ipc.sendSync("NJSIWitnessController.fundWitnessAccount", funding_account_UUID, witness_account_UUID, funding_amount, requestedLockPeriodInBlocks));
}
...
return handleError(ipc.sendSync("NJSIGenerationController.startGeneration", numThreads, memoryLimit));
}
