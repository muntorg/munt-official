...
class ExampleUnitTest
{
    ...
    @Test fun parseNocksTx()
    {
        ...
        val nativeAddress = context.read<List<String>>("\$.data.payments.data[*].metadata.address").first()

        println("transact $amountNLG $sourceCurrency into $amountEUR $targetCurrency address $nativeAddress")
        ...
        assertEquals("GaSq3VWKoRpoCCekaQBkLMr5i3MHwwxgEW", nativeAddress)
    }
