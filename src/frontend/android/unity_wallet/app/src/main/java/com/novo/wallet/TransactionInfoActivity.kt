...
import com.novo.jniunifiedbackend.TransactionRecord
import com.novo.jniunifiedbackend.TransactionStatus
...
class TransactionInfoActivity : AppBaseActivity() {
    ...
    private fun fillTxInfo() {
        ...
        try {
            val tx = UnifiedBackend.getTransaction(txHash)
    ...
    override fun onResume() {
        ...
        UnifiedBackend.RegisterMonitorListener(monitoringListener)
    }

    override fun onPause() {
        UnifiedBackend.UnregisterMonitorListener(monitoringListener)
