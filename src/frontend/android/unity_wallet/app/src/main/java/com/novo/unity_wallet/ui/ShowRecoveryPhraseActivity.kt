package com.novo.unity_wallet.ui
...
import com.novo.unity_wallet.util.setFauxButtonEnabledState
...
class ShowRecoveryPhraseActivity : AppBaseActivity(), UnityCore.Observer
{
    ...
    //fixme: (NOVO) Change to char[] to we can securely wipe.
    ...
    internal inner class ActionBarCallBack : ActionMode.Callback
    {
        ...
        override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean
        {
            ...
            // Handle buy button
            val itemBuy = menu.findItem(R.id.item_buy_novo)
