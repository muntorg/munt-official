        ...
        builder.setTitle(getString(R.string.wallet_birth_heading))
                .setItems(R.array.wallet_birth_date) { dialog, selection ->
                    ...
                    when (selection)
                    {
                        ...
                        3 -> chooseAccessCodeAndProceed(GuldenUnifiedBackend.ComposeRecoveryPhrase(recoveryPhrase, unixTime-(86400*365)))
                        4 -> chooseAccessCodeAndProceed(GuldenUnifiedBackend.ComposeRecoveryPhrase(recoveryPhrase, unixTime-(86400*365*2)))
                        ...
                        5 -> chooseAccessCodeAndProceed(GuldenUnifiedBackend.ComposeRecoveryPhrase(recoveryPhrase, 1441212522))
                    }
                }
        builder.create().show()
    }
