...
class ReceiveFragment : AppBaseFragment() {
    ...
    private fun copyToClipboard() {
        val clip: ClipData = ClipData.newPlainText(getString(R.string.novo_address_clipboard_label), currentAddressLabel.text)
    ...
    private fun updateAddress()
    {
        if (currentAddressQrView != null)
        {
            ...
            val imageData = ILibraryController.QRImageFromString("novo://$address", 600)
