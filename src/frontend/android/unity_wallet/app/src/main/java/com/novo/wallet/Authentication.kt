...
import com.novo.wallet.Constants.ACCESS_CODE_ATTEMPTS_ALLOWED
import com.novo.wallet.Constants.ACCESS_CODE_LENGTH
    ...
    private fun chooseNewWithRecovery(context: Context) {
        ...
        context.alert(Appcompat) {
            ...
            positiveButton(android.R.string.ok) {
                if (UnityCore.instance.walletReady.isCompleted && UnifiedBackend.IsMnemonicCorrect(contentView.recoveryPhrase.text.toString())) {
                    ...
                    object : TextWatcher {
                        ...
                        override fun afterTextChanged(s: Editable?) {
                            if (s?.length == ACCESS_CODE_LENGTH)
                            {
                                ...
                                if (UnityCore.instance.walletReady.isCompleted && UnifiedBackend.UnlockWallet(chosenCode.joinToString(""))) {
