...
import com.florin.unity_wallet.Config.Companion.RATE_FETCH_INTERVAL
...
private const val APP_MARKET_URL = "https://api.florin.org/api/v1/ticker"
 ...
 * @return conversion rate to convert from florin to specified currency (ie. value = florin * rate)
 */
