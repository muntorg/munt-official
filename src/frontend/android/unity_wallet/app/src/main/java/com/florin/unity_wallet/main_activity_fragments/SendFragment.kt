...
import com.florin.unity_wallet.ui.AddressBookAdapter
...
class SendFragment : AppBaseFragment(), UnityCore.Observer {
    ...
    override fun onWalletReady() {
        ...
        sellButton.setOnClickListener {
            ...
            val failURL = "https://florin.org/sell"
                    ...
                    Response.Listener { response ->
                        try
                        {
                            ...
                            if (jsonResponse.getInt("status_code") == 200)
                            {
                                ...
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://blockhut.com/sellflorin.php?sessionid=%s".format(sessionID)))
    ...
    {
        // Enable clipboard button if it contains a valid IBAN, Florin address or Uri
        val text = clipboardText()
        try {
