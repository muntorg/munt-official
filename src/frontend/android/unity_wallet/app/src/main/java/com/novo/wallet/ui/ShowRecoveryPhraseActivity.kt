    ...
    fun onAcceptRecoveryPhrase(view: View)
    {
        ...
        Authentication.instance.chooseAccessCode(this, null) {
            ...
            if (UnityCore.instance.isCoreReady()) {
                if (UnifiedBackend.ContinueWalletFromRecoveryPhrase(recoveryPhrase, password.joinToString(""))) {
                    gotoWalletActivity(this)
                } else {
                ...
                if (!UnifiedBackend.InitWalletFromRecoveryPhrase(recoveryPhrase, password.joinToString("")))
