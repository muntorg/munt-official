...
import com.novo.wallet.ui.AddressBookAdapter
import com.novo.wallet.util.AppBaseFragment
import com.novo.wallet.util.SwipeToDeleteCallback
...
class SendFragment : AppBaseFragment(), UnityCore.Observer {
    ...
    override fun onWalletReady() {
        ...
        val addresses = UnifiedBackend.getAddressBookRecords()
    ...
    override fun onAddressBookChanged() {
        val newAddresses = UnifiedBackend.getAddressBookRecords()
        runOnUiThread {
