            ...
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    if (ILibraryController.HaveUnconfirmedFunds()) {
                        performDialog(R.string.failed_novosync_warning_title, R.string.failed_novosync_unconfirmed_funds_message, false) {
                            it.dismiss()
                        }
                        return
                    }
                    ...
                    performDialog(
                            R.string.novosync_info_title,
                            if (ILibraryController.GetBalance() > 0) R.string.novosync_info_message_non_empty_wallet else R.string.novosync_info_message_empty_wallet, true
                    ) {
                        it.dismiss()
