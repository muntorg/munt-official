package com.florin.unity_wallet.ui
...
import com.florin.unity_wallet.util.setFauxButtonEnabledState
...
class ShowRecoveryPhraseActivity : AppBaseActivity(), UnityCore.Observer
{
    ...
    //fixme: (FLORIN) Change to char[] to we can securely wipe.
