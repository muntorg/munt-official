...
import com.florin.jniunifiedbackend.UriRecord
...
fun createRecipient(text: String): UriRecipient {
    ...
    // if there is a scheme it should equal florin, but that will be checked inside C++, so just pass it through
