 ...
 *
 * This file contains modifications by The Florin developers
 * All modifications copyright (C) The Florin developers
 */
package com.florin.barcodereader
...
class BarcodeCaptureActivity : AppCompatActivity(), BarcodeTracker.BarcodeUpdateListener
{
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray)
    {
        ...
        builder.setTitle("Florin").setMessage("Unable to get camera permission").setPositiveButton("ok", listener).show()
    }
