...
import com.novo.unity_wallet.Config.Companion.PRECISION_SHORT
import com.novo.unity_wallet.R.layout.text_input_address_label
import com.novo.unity_wallet.ui.getDisplayDimensions
import com.novo.unity_wallet.util.invokeNowOrOnSuccesfullCompletion
...
class SendCoinsFragment : BottomSheetDialogFragment(), CoroutineScope
{
    ...
    private fun confirmAndCommitNovoPayment()
    {
        ...
        try {
            ...
            if (fee + amountNative > balance) {
                ...
                fragmentActivity.alert(Appcompat, message, getString(R.string.send_novo_title)) {
