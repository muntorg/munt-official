...
import com.novo.unity_wallet.main_activity_fragments.*
import com.novo.unity_wallet.ui.monitor.NetworkMonitorActivity
...
import com.novo.jniunifiedbackend.IWalletController
import com.novo.unity_wallet.ui.getDisplayDimensions
import com.novo.unity_wallet.util.*
        ...
        SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    fun onRequestSupport(view: View? = null)
    {
        try
        {
            ...
            i.putExtra(Intent.EXTRA_EMAIL, arrayOf("support@novocurrency.com"))
                ...
                if (!ILibraryController.ReplaceWalletLinkedFromURI(linkURI, password.joinToString("")))
                {
                    runOnUiThread {
                        AlertDialog.Builder(this)
                                .setTitle(getString(R.string.no_novosync_warning_title))
                                .setMessage(getString(R.string.no_novosync_warning))
                ...
                Response.Listener { response ->
                    try
                    {
                        ...
                        if (jsonResponse.getInt("status_code") == 200)
                        {
                            ...
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://blockhut.com/buynovo.php?sessionid=%s".format(sessionID)))
