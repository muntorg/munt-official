...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData){
        {
            ...
            { 1130452, { uint256S("0x10b8bfc8b26b1459ef3bd387e75f62d5b62d6ace580fa00a75fc7d2fdb6824c0"), 1585855637 } },
            { 1131604, { uint256S("0x1094d308ac62ccf16f121a17d63bb6e031cd423afd27bc55726b11bced48bca3"), 1586017391 } },
        }
        };

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x1094d308ac62ccf16f121a17d63bb6e031cd423afd27bc55726b11bced48bca3");
        
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0000000000000000000000000000000000000000000000013805beeac7c80f35");
        
        chainTxData = ChainTxData{
            1586017391, // * UNIX timestamp of last checkpoint block
            2872119,    // * total number of transactions between genesis and last checkpoint
