...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Guldencoin Core guldencoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  guldencoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded guldencoin transaction") + "\n" +
              "  guldencoin-tx [options] -create [commands]   " + _("Create hex-encoded guldencoin transaction") + "\n" +
              "\n";
