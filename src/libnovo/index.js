...
import libNovo from "native-ext-loader!./libnovo_unity.node";
...
class LibNovo {
  constructor(options) {
    ...
    this.win = null;
    this.backend = new libNovo.NJSGuldenUnifiedBackend();
    this.signalHandler = new libNovo.NJSGuldenUnifiedFrontend();
  }
