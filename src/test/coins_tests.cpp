...
BOOST_AUTO_TEST_CASE(ccoins_serialization)
{
    //*
    // Good example
    CDataStream ss1(ParseHex("97f23c005847f80d0000001976a914816115944e077fe7c803cfa57f29b36bf87c1d3588ac"), SER_DISK, CLIENT_VERSION);
    Coin cc1;
    ss1 >> cc1;
    ...
    // Good example
    CDataStream ss2(ParseHex("8ddf773daf0100000000001976a9148c988f1a4a4de2161e0f50aac7f17e7f9555caa488ac"), SER_DISK, CLIENT_VERSION);
    Coin cc2;
    ss2 >> cc2;
    ...
    CDataStream ss3(ParseHex("00000000000000000000"), SER_DISK, CLIENT_VERSION);
    Coin cc3;
    ss3 >> cc3;
    BOOST_CHECK_EQUAL(cc3.fCoinBase, false);
    BOOST_CHECK_EQUAL(cc3.nHeight, 0);
    BOOST_CHECK_EQUAL(cc3.out.nValue, 0);
    BOOST_CHECK_EQUAL(cc3.out.output.scriptPubKey.size(), 0);
