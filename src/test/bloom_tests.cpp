...
{
    BOOST_FAIL("Does not work for Gulden yet. When implementing SPV is likely a good oppertunity to fix this test.");
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    BOOST_CHECK(merkleBlock.header.GetHashLegacy() == block.GetHashLegacy());
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_gulden with --log_level=message to see BOOST_TEST_MESSAGEs:
