...
#include <qt/forms/ui_viewaddressdialog.h>
...
{
    //fixme: (POST-PHASE5) This QR is "witness" instead of "gulden" to interoperate with special "witness watch" iOS app - this isn't ideal, revisit Qr schemes going forward.
