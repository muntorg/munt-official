    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Mining reward"), TransactionFilterProxy::TYPE(TransactionRecord::Generated));
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(GuldenUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
