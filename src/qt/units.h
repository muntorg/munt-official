...
*/
class GuldenUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GuldenUnits(QObject *parent);
    ...
    //! Format as string
    static QString format(int unit, const CAmount& amount, bool plussign=false, SeparatorStyle separators=separatorStandard, int numDecimals=-1, bool trimTrailingZerosInRemainder=false);
    //! Format as string (with unit)
    static QString formatWithUnit(int unit, const CAmount& amount, bool plussign=false, SeparatorStyle separators=separatorStandard, int numDecimals=-1, bool trimTrailingZerosInRemainder=false);
...
typedef GuldenUnits::Unit GuldenUnit;
