    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Guldencoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and guldencoin: URIs)"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Guldencoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Guldencoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Guldencoin Core"));
    ...
    openAction->setStatusTip(tr("Open a guldencoin: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Guldencoin Core help message to get a list with possible Guldencoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Guldencoin Core client") + " " + networkStyle->getTitleAddText();
