...
"%s)"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Use the accelerated test network, accelerated testnet does not use seeding, "
"please use -addnode to setup your own network, you can use -targetspeed to "
"adjust the target spacing for your private accelerated testnet."),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) 2009-%i The Guldencoin Core Developers"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Guldencoin Core is shutting down."),
