...
QString BitcoinUnits::description(int unit)
{
    switch (unit) {
    case BTC:
        return QString("Gulden");
    case mBTC:
        return QString("Milli-Gulden (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC:
        return QString("Micro-Gulden (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default:
        return QString("???");
    }
}
