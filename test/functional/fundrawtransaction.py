...
class RawTransactionsTest(GuldenTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid Gulden address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        GuldenD_processes[1].wait(timeout=GULDEND_PROC_WAIT_TIMEOUT)
