...
Contains files used to package GuldenD/Gulden
...
PGP keys used for signing Gulden Core [Gitian release](/doc/release-process.md) results.

### [MacDeploy](/contrib/macdeploy) ###
Scripts and notes for Mac builds. 

### [RPM](/contrib/rpm) ###
RPM spec file for building gulden-core on RPM based distributions
...
This script attempts to download and verify the signature file SHA256SUMS.asc from gulden.org.
