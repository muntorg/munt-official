  ...
  BITCOIN_QT_CHECK([
    if test x$qt_include_path != x; then
      if test x$TARGET_OS = xwindows; then
          ...
          QT_INCLUDES="-I$qt_include_path -I$qt_include_path/QtCore -I$qt_include_path/QtWebEngine -I$qt_include_path/QtWebEngineWidgets -I$qt_include_path/QtGui -I$qt_include_path/QtWidgets -I$qt_include_path/QtNetwork -I$qt_include_path/QtTest -I$qt_include_path/QtDBus"
      fi
      CPPFLAGS="$QT_INCLUDES $CPPFLAGS"
    fi
  ])
