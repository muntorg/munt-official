...
do
  ...
  ${STRIP} --only-keep-debug src/frontend/android/unity_wallet/app/src/main/jniLibs/${jni_lib}/lib_unity_jni.so src/frontend/android/unity_wallet/app/src/main/jniLibs/${jni_lib}/lib_unity_jni.so.dbg
  ${STRIP} --only-keep-debug src/frontend/android/unity_wallet/app/src/main/jniLibs/${jni_lib}/libc++_shared.so src/frontend/android/unity_wallet/app/src/main/jniLibs/${jni_lib}/libc++_shared.so.dbg
