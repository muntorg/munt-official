...
export CXXFLAGS="${CXXFLAGS} -I${DIR}/../build_node/electron-${ELECTRON_VERSION}/node_headers/include/node/ -I${DIR}/../build_node/node-addon-api-${NODE_ADDON_API_VERSION}/package/ ${EXTRA_CXX_FLAGS} -O2 -O0 -g3 -DDEBUG -DDEBUG_LOCKORDER"
export CFLAGS=${CXXFLAGS}
